...
Version: 0.1
Keywords: tools
Homepage: https://github.com/benleis1/wikimode
...
# Installation
 ...
 2. add the following to your init file
      (use-package wikimode
        :load-path "[path to wikimode directory")
...
- [wikimode.el ](#wikimodeel)
- [Commentary:](#commentary)
- [Installation](#installation)
- [Code:](#code)
- [Frontmatter / tag parsing](#frontmatter--tag-parsing)
  - [wikimode--frontmatter-lines](#wikimode--frontmatter-lines)
  - [wikimode--split-inline-tags](#wikimode--split-inline-tags)
  - [wikimode--collect-block-tags](#wikimode--collect-block-tags)
  - [wikimode--parse-tags](#wikimode--parse-tags)
  - [wikimode--parse-body-tags](#wikimode--parse-body-tags)
  - [wikimode--parse-title](#wikimode--parse-title)
  - [wikimode--org-p](#wikimode--org-p)
  - [wikimode--parse-org-title](#wikimode--parse-org-title)
  - [wikimode--parse-org-tags](#wikimode--parse-org-tags)
  - [wikimode--file-tags-and-title](#wikimode--file-tags-and-title)
- [Project scanning](#project-scanning)
  - [wikimode--find-root](#wikimode--find-root)
  - [wikimode--extension-p](#wikimode--extension-p)
  - [wikimode--relative-current-file](#wikimode--relative-current-file)
  - [wikimode--main-window-file](#wikimode--main-window-file)
  - [wikimode--collect-files](#wikimode--collect-files)
  - [wikimode--hash-keys](#wikimode--hash-keys)
  - [wikimode--build-tag-tables](#wikimode--build-tag-tables)
  - [wikimode-refresh](#wikimode-refresh)
- [Sorting](#sorting)
  - [wikimode--file-matches-filter-p](#wikimode--file-matches-filter-p)
  - [wikimode--sorted-files](#wikimode--sorted-files)
  - [wikimode--tag-matches-filter-p](#wikimode--tag-matches-filter-p)
  - [wikimode--tags-in-use](#wikimode--tags-in-use)
  - [wikimode--sorted-tags](#wikimode--sorted-tags)
- [Rendering](#rendering)
  - [wikimode--insert-list-section](#wikimode--insert-list-section)
  - [wikimode--file-display-name](#wikimode--file-display-name)
  - [wikimode--insert-file-line](#wikimode--insert-file-line)
  - [wikimode--insert-tag-line](#wikimode--insert-tag-line)
  - [wikimode--render](#wikimode--render)
- [Commands](#commands)
  - [wikimode-toggle-section](#wikimode-toggle-section)
  - [wikimode-clear-tag-filter](#wikimode-clear-tag-filter)
  - [wikimode-filter-section](#wikimode-filter-section)
  - [wikimode-clear-section-filter](#wikimode-clear-section-filter)
  - [wikimode-cycle-file-sort](#wikimode-cycle-file-sort)
  - [wikimode-cycle-tag-sort](#wikimode-cycle-tag-sort)
  - [wikimode--select-main-window](#wikimode--select-main-window)
  - [wikimode-search](#wikimode-search)
  - [wikimode-return](#wikimode-return)
  - [wikimode-mouse-return](#wikimode-mouse-return)
- [Major mode](#major-mode)
- [Window display](#window-display)
  - [wikimode--display-buffer](#wikimode--display-buffer)
  - [wikimode--install-display-buffer](#wikimode--install-display-buffer)
  - [wikimode--get-buffer-create](#wikimode--get-buffer-create)
  - [wikimode--maybe-auto-refresh](#wikimode--maybe-auto-refresh)
  - [wikimode-toggle](#wikimode-toggle)
- [wikimode.el ends here](#wikimodeel-ends-here)
...
## wikimode--relative-current-file
...
## wikimode--file-matches-filter-p
```
